...
open class BaseKotlinAdapter<T>() : RecyclerView.Adapter<BaseKotlinAdapter<T>.ViewHolder>() {
    ...
    constructor(layoutId: Int, list: List<T>?, viewHolder: ((RecyclerView.ViewHolder, T) -> Unit),
                clickableViews: List<Int>, clickListener: ((View, Int) -> Unit)?) : this() {
    ...
    constructor(layoutId: Int, list: List<T>?, viewHolder: ((RecyclerView.ViewHolder, T) -> Unit),
                clickableView: Int, clickListener: ((View, Int) -> Unit)? = null) : this() {
        this.layoutId = layoutId
        this.list = list
        this.viewHolder = viewHolder
